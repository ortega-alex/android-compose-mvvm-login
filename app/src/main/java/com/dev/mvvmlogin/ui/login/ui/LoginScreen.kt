package com.dev.mvvmlogin.ui.login.ui
...
fun Login(modifier: Modifier, viewModel: LoginViewModel) {
    ...
    if (isLoading) {
        ...
        Column(modifier = Modifier) {
            ...
            EmailFiel(email, { viewModel.onLoginChange(it, password) })
...
fun PasswordField(password: String, onTextFieldChange: (String) -> Unit) {
    TextField(
        ...
        colors = TextFieldDefaults.textFieldColors(
            textColor = Color(color = 0xFF636262),
...
@Composable
fun EmailFiel(email: String, onTextFieldChange: (String) -> Unit) {
    TextField(
